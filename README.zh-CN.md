...
<p align="center">
  <img src="docs/images/metis-speed.svg" width="100%" alt="Metis 与 OpenCode 的用户实测任务完成时间对比" />
</p>
...
<p align="center">
  <img src="docs/images/metis-capabilities.svg" width="100%" alt="Metis 的记忆、Dream、搜索和验证能力" />
</p>
...
<p align="center">
  <img src="docs/images/metis-workflow.svg" width="100%" alt="Metis 工作流：理解、执行、验证" />
</p>
